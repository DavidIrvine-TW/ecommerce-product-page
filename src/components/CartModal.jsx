...
function CartModal({ cartActive, setCartItems, cartItems, count, setCount, cost, setCost }) {
  ...
  return (
    <div id="modal-mobile" className={`modal ${modal} bg-white rounded-xl mx-[0.5rem] my-[0.5rem] p-[1.5rem] h-[256px] z-10 max-w-full top-0 absolute `}>
